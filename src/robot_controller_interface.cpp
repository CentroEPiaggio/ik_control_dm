...
{
    if(!ros::service::waitForService(move_group::EXECUTE_ACTION_NAME))  // TODO: This is a change from kinetic to melodic... Check if it works
    {
        ROS_ERROR_STREAM_NAMED(CLASS_LOGNAME,CLASS_NAMESPACE << __func__ << " : trajectory execution service NOT found!");
        return;
    }
    execute_service_ = node.serviceClient<moveit_msgs::ExecuteKnownTrajectory>(move_group::EXECUTE_ACTION_NAME);  // TODO: This is a change from kinetic to melodic... Check if it works
